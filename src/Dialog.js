  ...
  const handleSend = async () => {
    ...
    try {
      const response = await openai.createCompletion({
        model: "text-davinci-003", //For security reasons and due to the model being paid, I removed it from the code. The public code on GitHub will not include this specific implementation.
        prompt: prompt,
        temperature: 0.5,
        max_tokens: 150,
      });
